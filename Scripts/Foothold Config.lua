...
GlobalSettings.difficultyScaling = { [1]=1.3, [2]=1.0 }
...
ewrs_defaultShowTankers = false -- Default show tankers in picture report (still requires Show Friendlies)
